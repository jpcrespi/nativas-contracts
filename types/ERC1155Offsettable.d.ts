...
export interface ERC1155OffsettableContract
  extends Truffle.Contract<ERC1155OffsettableInstance> {
  "new"(
    logger_: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ERC1155OffsettableInstance>;
}
...
export interface ERC1155OffsettableInstance extends Truffle.ContractInstance {
  /**
